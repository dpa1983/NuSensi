...
path_results="path_results_replacement"
ppn_path="ppn_path_replacement"
#PPN_DIR="ppn_dir_replacement"
#factor=factor_replacement
network_start=network_start_replacement
network_stop=network_stop_replacement
cycle=(cycle_replacement)
NVAL=nval_replacement
procs=$1
delete_ppn_dirs=deleteppndirreplacement
#####
...
do
	...
	do
		...
		line=$(perl <<"EOF"
			my($baseName) = $ENV{"JOB_PATH"} . '/runlist.hist';
